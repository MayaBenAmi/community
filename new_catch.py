...
class Player(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.width = 800
        self.height = 600
        self.image = pygame.image.load('happy_bunny_new.png').convert_alpha()
...
class Show_title(object):
    def show_title_screen(self, screen, app):
        ...
        height = app.height
        screen.fill(WHITE)
        draw_text(screen, "Catch Earth", 70, width / 2, height / 4)
        draw_text(screen, "Collect the earth icons while avoiding the polluting factories", 30, width / 2, height / 2.5)
        draw_text(screen, "Collect 20 points in order to win", 30, width / 2, height / 2.25)
